  ...
  return (
    <Popover open={open} onOpenChange={setOpen} {...props}>
      <PopoverTrigger asChild>
        <Button variant="outline" role="combobox" aria-expanded={open} className="w-full justify-between min-h-[3rem] h-auto">
          <div className="flex gap-1 flex-wrap overflow-x-auto max-h-[6rem] items-center">
            {selected.length > 0 ? (
              selected.map((option) => (
